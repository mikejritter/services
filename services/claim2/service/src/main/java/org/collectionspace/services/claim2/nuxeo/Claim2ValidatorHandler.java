 ...
 */
package org.collectionspace.services.claim2.nuxeo;
...
/**
 * Validation handler for Claim2. Checks for the common part and claimNumber on create.
 */
public class Claim2ValidatorHandler extends ValidatorHandlerImpl<PoxPayloadIn, PoxPayloadOut> {
    ...
    protected Class<?> getCommonPartClass() {
        return Claims2Common.class;
    }

    @Override
    protected void handleCreate() throws InvalidDocumentException {
        final Claims2Common claim = (Claims2Common) getCommonPart();
        if (claim == null) {
